return {
	...
	ANNOUNCE_PUGALISK_INVULNERABLE = {"Its hide is too tough!", "A tough nut to crack.", "Break, darn you!"},
    ...
    --- DLC ------------------------------------------------------------------------------------------------    
        ...
        TEATREE_NUT = "Hey there, baby tree.",    
        ...
        DEED = "At last a home for my science.",
        ...
        POG = "Science says it's always hungry.",
        ...
        PORKLAND_INTRO = "I already don't like that guy.",
    	...
    	APOKALYPSE_HERALD = "Metaphysical end-ity.",
    	...
    	GUMMY_CAKE = "Chewy and confectionary.",
